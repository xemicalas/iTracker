...
namespace KTU\AdminBundle\Entity;
...
class Counters
{
    ...
    /**
     * @var \KTU\AdminBundle\Entity\Categories
     *
     * @ORM\ManyToOne(targetEntity="KTU\AdminBundle\Entity\Categories")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \KTU\AdminBundle\Entity\Users
     *
     * @ORM\ManyToOne(targetEntity="KTU\AdminBundle\Entity\Users")
     * @ORM\JoinColumns({
    ...
    /**
     * @var collection
     * @ORM\OneToMany(targetEntity="KTU\AdminBundle\Entity\CounterStatistics", mappedBy="counter_id")
     */
     ...
     * Set cat
     *
     * @param \KTU\AdminBundle\Entity\Categories $cat
     * @return Counters
     */
     ...
     * Get cat
     *
     * @return \KTU\AdminBundle\Entity\Categories
     */
     ...
     * Set user
     *
     * @param \KTU\AdminBundle\Entity\Users $user
     * @return Counters
     */
    public function setUser(\KTU\AdminBundle\Entity\Users $user = null)
    {
        $this->user_id = $user;
     ...
     * Get user
     *
     * @return \KTU\AdminBundle\Entity\Users
     */

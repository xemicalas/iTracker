...
class CategoriesController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('KTUAdminBundle:Categories:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        return $this->render('KTUAdminBundle:Categories:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('KTUAdminBundle:Categories:edit.html.twig', array(
            'entity'      => $entity,
